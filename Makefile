...
pack:
	...
	@npx --yes bestzip sogeBot-$(VERSION).zip .npmrc .env* package-lock.json patches/ packages/ dest/ locales/ LICENSE package.json docs/ AUTHORS tools/ bin/ bat/ fonts.json assets/ favicon.ico
